error id: file:///C:/Users/wesle/Desktop/School/project/simp/src/main/scala/sutd/compiler/simp/syntax/Parser.scala:
file:///C:/Users/wesle/Desktop/School/project/simp/src/main/scala/sutd/compiler/simp/syntax/Parser.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -sutd/compiler/simp/syntax/Lexer.eps.
	 -sutd/compiler/simp/syntax/Lexer.eps#
	 -sutd/compiler/simp/syntax/Lexer.eps().
	 -sutd/compiler/simp/syntax/SrcLoc.eps.
	 -sutd/compiler/simp/syntax/SrcLoc.eps#
	 -sutd/compiler/simp/syntax/SrcLoc.eps().
	 -sutd/compiler/simp/syntax/AST.eps.
	 -sutd/compiler/simp/syntax/AST.eps#
	 -sutd/compiler/simp/syntax/AST.eps().
	 -sutd/compiler/simp/syntax/Parsec.eps.
	 -sutd/compiler/simp/syntax/Parsec.eps#
	 -sutd/compiler/simp/syntax/Parsec.eps().
	 -Stmt.eps.
	 -Stmt.eps#
...
object Parser {
    ...
    /** Lab 1 Task 1.2 
      ...
      * @return
      */
    // after applying left recursion elimination,
    def p_exp:Parser[PEnv, Exp] = choice(choice(p_var_expp)(p_const_expp))(p_paren_expp)

    def p_expp:Parser[PEnv, Exp] = choice(p_op_exp_expp)(e@@ps)

    def p_exp_op:Parser[PEnv, Exp] = for {
        e1 <- p_exp
        _ <- p_spaces
        ...
        case PlusSign(_) => Plus(e1, e2)
        case MinusSign(_) => Minus(e1, e2)
        case AsterixSign(_) => Mult(e1, e2)
        case DEqSign(_) => DEqual(e1, e2)
        case LThanSign(_) => LThan(e1, e2)
    }

    def p_exp_paren:Parser[PEnv, Exp] = for {
        _ <- p_lparen
        _ <- p_spaces
        e <- p_exp
        _ <- p_spaces
    ...
    def p_exp_var:Parser[PEnv, Exp] = for {     // to change type to var
        v <- p_var
    } yield VarExp(v)

    def p_exp_const:Parser[PEnv, Exp] = for {   // to change type to const
        c <- p_const        
    } yield ConstExp(c)
